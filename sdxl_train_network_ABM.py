...
if __name__ == "__main__":
    ...
    # Optimize data loader workers default
    if args.max_data_loader_n_workers is None:
        args.max_data_loader_n_workers = 8
    ...
    # Inject ABM Batch Size
    if args.abm_enabled and args.abm_batch_size is not None:
         if args.network_args is None: args.network_args = []
         args.network_args.append(f"abm_batch_size={args.abm_batch_size}")
